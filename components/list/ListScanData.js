...
import { StyleSheet, View, Text, TextInput, Button, Alert, ActivityIndicator, BackHandler, ScrollView } from 'react-native';
...
export default class ListScanData extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        this.props.navigation.setOptions({
            headerTitle: () => { return (<Text style={styles.heading} >Scan Result</Text>) },
        })
    }
        ...
        return (
            <ScrollView contentContainerStyle={{ flexGrow: 1 }} keyboardShouldPersistTaps='handled' >
                <Surface style={styles.container}>
                    <Text style={styles.inputMessage}>Details </Text>
